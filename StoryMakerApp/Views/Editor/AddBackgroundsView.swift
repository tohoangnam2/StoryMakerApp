            ...
            ZStack {
                if let frame = frame {
                    if let project = project {
                        ...
                        //check file tồn tại ko , có file thì đọc dữ liệu dạng data, chuyển data = img
...
//                        else {
//                            //Nếu không có ảnh local thì fallback sang AsyncImage (ảnh online)
//                            if let url = frame.backgroundURL {
...
//                                Color.gray
//                                    .onAppear {
//                                        print("Không có URL online cho frame \(frame.id)")
//                                    }
//                            }
//                        }
                    }
